...
func TestNewProviderPreservesIdentityAndModel(t *testing.T) {
	t.Parallel()
...
func TestGenerateRejectsMismatchedModelBeforeNetwork(t *testing.T) {
	t.Parallel()
...
func TestGenerateRejectsUnmarshalableToolSchemaBeforeNetwork(t *testing.T) {
	t.Parallel()
...
func TestBuildGenerateContentRequestAssemblesValidRequestWithoutNetwork(t *testing.T) {
	t.Parallel()
	...
	model, contents, conf, err := p.buildGenerateContentRequest(provider.GenerateParams{
		...
		Messages: []provider.Message{
			{Role: "system", Content: "Follow provider policy."},
	...
	assert.Equal(t, "Follow provider policy.", conf.SystemInstruction.Parts[0].Text)
...
func TestListModelsReturnsCanceledContextErrorBeforeNetwork(t *testing.T) {
	t.Parallel()
...
func TestConvertSchemaMapsNestedJSONSchema(t *testing.T) {
	t.Parallel()
...
func TestConvertSchemaReportsMarshalErrors(t *testing.T) {
	t.Parallel()
...
func TestHelperMatchingCoversIDAndNameFallbacks(t *testing.T) {
	t.Parallel()
