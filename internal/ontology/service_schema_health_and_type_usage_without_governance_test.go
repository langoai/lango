...
func TestServiceSchemaHealthAndTypeUsageWithoutGovernance(t *testing.T) {
...
func TestServiceGovernanceDelegationErrors(t *testing.T) {
...
func TestServicePermissionDeniedShortCircuitsDelegation(t *testing.T) {
	reg := newServiceSchemaHealthAndTypeUsageWithoutGovernanceRegistry()
	svc := ontology.NewService(reg, nil)
...
func TestServiceMissingDependencyDelegationErrors(t *testing.T) {
...
func TestServiceActionExecutorDelegatesListAndPreLogErrors(t *testing.T) {
	svc := ontology.NewService(newServiceSchemaHealthAndTypeUsageWithoutGovernanceRegistry(), nil)
	...
	require.NoError(t, err)
	adminSummary := requireServiceSchemaHealthAndTypeUsageWithoutGovernanceActionSummary(t, summaries, "admin_only")
...
func requireServiceSchemaHealthAndTypeUsageWithoutGovernanceActionSummary(
	t *testing.T,
...
type serviceSchemaHealthAndTypeUsageWithoutGovernanceDenyACL struct{}

func (serviceSchemaHealthAndTypeUsageWithoutGovernanceDenyACL) Check(principal string, required ontology.Permission) error {
	return fmt.Errorf("%w: principal %q requires %d", ontology.ErrPermissionDenied, principal, required)
}

type serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry struct {
...
func newServiceSchemaHealthAndTypeUsageWithoutGovernanceRegistry() *serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry {
	return &serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry{
...
func (r *serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry) resetCalls() {
	r.calls = make(map[string]int)
}

func (r *serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry) RegisterType(_ context.Context, objType ontology.ObjectType) error {
	r.calls["RegisterType"]++
	r.types[objType.Name] = objType
	return nil
}

func (r *serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry) GetType(_ context.Context, name string) (*ontology.ObjectType, error) {
	r.calls["GetType"]++
	if r.getTypeErr != nil {
...
func (r *serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry) ListTypes(context.Context) ([]ontology.ObjectType, error) {
	r.calls["ListTypes"]++
...
func (r *serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry) DeprecateType(_ context.Context, name string) error {
...
func (r *serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry) RegisterPredicate(
	_ context.Context,
...
func (r *serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry) GetPredicate(
	_ context.Context,
	name string,
...
func (r *serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry) ListPredicates(context.Context) ([]ontology.PredicateDefinition, error) {
...
func (r *serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry) DeprecatePredicate(_ context.Context, name string) error {
...
func (r *serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry) UpdateTypeStatus(
	_ context.Context,
	name string,
...
func (r *serviceSchemaHealthAndTypeUsageWithoutGovernanceRegistry) UpdatePredicateStatus(
	_ context.Context,
	name string,
	status ontology.SchemaStatus,
) error {
