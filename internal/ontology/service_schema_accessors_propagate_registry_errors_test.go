...
func TestServiceSchemaAccessorsPropagateRegistryErrors(t *testing.T) {
...
func TestServiceDeprecateAndPromoteBranchesUpdateVersionAndCache(t *testing.T) {
	ctx := context.Background()
	reg := newServiceSchemaHealthAndTypeUsageWithoutGovernanceRegistry()
	reg.types["Agent"] = ontology.ObjectType{Name: "Agent", Status: ontology.SchemaActive}
...
func TestServiceDelegatesTruthResolverAndP2PFactBranches(t *testing.T) {
	ctx := context.Background()
	conflictID := uuid.New()
	validAt := time.Date(2026, 5, 19, 12, 0, 0, 0, time.UTC)
	truth := &serviceSchemaAccessorsPropagateRegistryErrorsTruthMaintainer{
	...
	resolver := &serviceSchemaAccessorsPropagateRegistryErrorsResolver{
...
func TestServiceImportExportActionLogAndPermissionBranches(t *testing.T) {
	ctx := context.Background()
	reg := newServiceSchemaHealthAndTypeUsageWithoutGovernanceRegistry()
	reg.types["Agent"] = ontology.ObjectType{Name: "Agent", Status: ontology.SchemaActive}
	reg.predicates["uses"] = ontology.PredicateDefinition{Name: "uses", Status: ontology.SchemaActive}
	...
	client := enttest.Open(t, "sqlite3", "file:serviceSchemaAccessorsPropagateRegistryErrorsactions?mode=memory&_fk=1")
...
type serviceSchemaAccessorsPropagateRegistryErrorsTruthMaintainer struct {
...
func (tm *serviceSchemaAccessorsPropagateRegistryErrorsTruthMaintainer) AssertFact(_ context.Context, input ontology.AssertionInput) (*ontology.AssertionResult, error) {
	tm.assertInputs = append(tm.assertInputs, input)
	return tm.assertResult, nil
}

func (tm *serviceSchemaAccessorsPropagateRegistryErrorsTruthMaintainer) RetractFact(context.Context, string, string, string, string) error {
	tm.retractCalls++
	return nil
}

func (tm *serviceSchemaAccessorsPropagateRegistryErrorsTruthMaintainer) ConflictSet(context.Context, string, string) ([]ontology.Conflict, error) {
	return append([]ontology.Conflict(nil), tm.conflicts...), nil
}

func (tm *serviceSchemaAccessorsPropagateRegistryErrorsTruthMaintainer) ResolveConflict(context.Context, uuid.UUID, string, string) error {
	tm.resolveConflictCalls++
	return nil
}

func (tm *serviceSchemaAccessorsPropagateRegistryErrorsTruthMaintainer) FactsAt(context.Context, string, time.Time) ([]graph.Triple, error) {
	return append([]graph.Triple(nil), tm.factsAt...), nil
}

func (tm *serviceSchemaAccessorsPropagateRegistryErrorsTruthMaintainer) OpenConflicts(context.Context) ([]ontology.Conflict, error) {
	return append([]ontology.Conflict(nil), tm.openConflicts...), nil
}

type serviceSchemaAccessorsPropagateRegistryErrorsResolver struct {
...
func (r *serviceSchemaAccessorsPropagateRegistryErrorsResolver) Resolve(_ context.Context, rawID string) (string, error) {
...
func (*serviceSchemaAccessorsPropagateRegistryErrorsResolver) RegisterAlias(context.Context, string, string, string) error {
	return nil
}

func (r *serviceSchemaAccessorsPropagateRegistryErrorsResolver) DeclareSameAs(context.Context, string, string, string) error {
	r.declareCalls++
	return nil
}

func (r *serviceSchemaAccessorsPropagateRegistryErrorsResolver) Merge(context.Context, string, string) (*ontology.MergeResult, error) {
	r.mergeCalls++
	return r.mergeResult, nil
}

func (r *serviceSchemaAccessorsPropagateRegistryErrorsResolver) Split(context.Context, string, string) error {
	r.splitCalls++
	return nil
}

func (r *serviceSchemaAccessorsPropagateRegistryErrorsResolver) Aliases(context.Context, string) ([]string, error) {
