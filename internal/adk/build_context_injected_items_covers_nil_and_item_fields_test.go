...
func TestBuildContextInjectedItemsCoversNilAndItemFields(t *testing.T) {
	t.Parallel()
...
func TestEstimateKnowledgeTokensCoversNilEmptyAndItemOverhead(t *testing.T) {
	t.Parallel()
...
func TestEstimateRetrievedResultTokensCoversNilHeaderContentAndGraphNodes(t *testing.T) {
	t.Parallel()
...
func TestEstimateMemoryTokensCoversEmptyReflectionsAndObservations(t *testing.T) {
	t.Parallel()
...
func TestEstimateRunSummaryTokensCoversEmptyAndSummaryOverhead(t *testing.T) {
	t.Parallel()
...
func TestMergeRetrievalResultsCoversNilIdentityAndDisjointMerge(t *testing.T) {
	t.Parallel()
