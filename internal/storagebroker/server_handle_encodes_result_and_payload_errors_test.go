...
func TestServerHandleEncodesResultAndPayloadErrors(t *testing.T) {
	t.Parallel()
...
func TestDecodePayloadEmptyValidAndMalformedInputs(t *testing.T) {
	t.Parallel()
...
func TestServerPayloadProtectorEncryptDecryptAndVersionMismatch(t *testing.T) {
	t.Parallel()
...
func TestPayloadProtectorWrapsBrokerAPI(t *testing.T) {
	t.Parallel()

	require.Nil(t, NewPayloadProtector(nil))

	api := &serverHandleEncodesResultAndPayloadErrorsPayloadAPI{}
...
func TestOperationalDispatchRequiresOpenedDatabase(t *testing.T) {
	t.Parallel()
...
func (a *serverHandleEncodesResultAndPayloadErrorsPayloadAPI) EncryptPayload(_ context.Context, plaintext []byte) (EncryptPayloadResult, error) {
...
func (a *serverHandleEncodesResultAndPayloadErrorsPayloadAPI) DecryptPayload(_ context.Context, ciphertext, nonce []byte, keyVersion int) (DecryptPayloadResult, error) {
