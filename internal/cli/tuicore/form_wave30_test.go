...
func TestWave30FormUpdateReturnsWithoutFocusOrVisibleFields(t *testing.T) {
	form := NewFormModel("Wave 30")
	form.Focus = false
	form.AddField(&Field{
		Key:   "hidden",
		Label: "Hidden",
...
func TestWave30FormFieldOptionsLoadedFallsBackToManualInputForEmptyOptions(t *testing.T) {
	form := NewFormModel("Wave 30")
	form.Focus = true
	form.AddField(&Field{
		Key:         "model",
...
func TestWave30SearchSelectDropdownFiltersSelectsAndMarksEdited(t *testing.T) {
...
func TestWave30FormCursorClampsAfterVisibilityChanges(t *testing.T) {
	showSecond := true
	form := NewFormModel("Wave 30")
	form.Focus = true
	form.AddField(&Field{
...
func TestWave30InputSelectUnknownValueCyclesAndRunsReturnedCommand(t *testing.T) {
	form := NewFormModel("Wave 30")
	form.Focus = true
	form.AddField(&Field{
		Key:     "provider",
...
func TestWave30FormViewRendersLoadingReadOnlyAndDropdownHelpBranches(t *testing.T) {
	form := NewFormModel("Wave 30")
	form.Focus = true
	form.AddField(&Field{
		Key:     "loading",
