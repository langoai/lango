...
func TestWave56WizardChannelNavigationBoundsAndRendering(t *testing.T) {
	t.Parallel()
...
func TestWave56WizardSavesChannelAndSecurityConfigUpdates(t *testing.T) {
	t.Parallel()
	...
	setWave56WizardFieldValue(t, w, "telegram_token", "123456:token")
	...
	setWave56WizardFieldValue(t, w, "interceptor_policy", "all")
	model, cmd = w.Update(tea.KeyMsg{Type: tea.KeyCtrlN})
	w = model.(*Wizard)
	require.Nil(t, cmd)
...
func TestWave56WizardForwardsNonKeyMessagesToActiveForm(t *testing.T) {
	t.Parallel()
...
func TestWave56WizardNavigationAndCompletionBranches(t *testing.T) {
	t.Parallel()
...
func TestWave56WizardAgentValidationOutcomes(t *testing.T) {
	t.Parallel()
...
func setWave56WizardFieldValue(t *testing.T, w *Wizard, key, value string) {
	t.Helper()
