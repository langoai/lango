...
func TestMissionControlProjectorStatusHelpersCoverMappings(t *testing.T) {
	t.Parallel()
...
func TestMissionControlProjectorTimeAndSummaryHelpersCoverEdges(t *testing.T) {
	t.Parallel()
...
func TestMissionControlProjectorRuntimeHintAndBlockedAgentBranches(t *testing.T) {
	t.Parallel()
...
func TestMissionControlProjectorRunLedgerEnrichmentBranches(t *testing.T) {
	t.Parallel()
...
func TestMissionControlProjectorTaskAndAgentEnrichmentBranches(t *testing.T) {
	t.Parallel()
...
func TestMissionControlProjectorProposalProjectionBranches(t *testing.T) {
	t.Parallel()
...
func TestMissionControlProjectorDurableRowStatusAndDetailBranches(t *testing.T) {
	t.Parallel()
