...
func TestWave20MissionControlConstructorsWireSurfaceDependenciesAndComposer(t *testing.T) {
	t.Parallel()
...
func TestWave20MissionControlLifecycleAndRefreshCommandsAreDeterministic(t *testing.T) {
	t.Parallel()
...
func TestWave20MissionControlWideViewRendersBothTopLanes(t *testing.T) {
	t.Parallel()
...
func TestWave20MissionControlNavigationClampsMissionAndDecisionCursors(t *testing.T) {
	t.Parallel()
...
func TestWave20MissionControlProposalCommandErrorsReturnSystemMessages(t *testing.T) {
	t.Parallel()
	...
	t.Run("missing proposal row", func(t *testing.T) {
		...
		msgs := collectWave20ImmediateMsgs(cmd)
...
func TestWave20MissionControlProposalRestoreFailureIsReported(t *testing.T) {
	t.Parallel()
...
func TestWave20MissionControlLegacyLearningProposalUsesSuggestionFallback(t *testing.T) {
	t.Parallel()
...
func TestWave20MissionControlSubmitCommandAndErrorBranches(t *testing.T) {
	t.Parallel()
...
func TestWave20MissionControlHelperBoundaries(t *testing.T) {
	t.Parallel()
...
func collectWave20ImmediateMsgs(cmd tea.Cmd) []tea.Msg {
	if cmd == nil {
		return nil
	}
	msg := cmd()
	...
	case tea.BatchMsg:
		...
		for _, child := range msg {
			out = append(out, collectWave20ImmediateMsgs(child)...)
		}
		return out
	default:
		return []tea.Msg{msg}
