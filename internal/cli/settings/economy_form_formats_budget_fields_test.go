...
func TestEconomyFormFormatsBudgetFields(t *testing.T) {
	hardLimit := false
...
func TestEconomyRiskFormValidatesTrustScores(t *testing.T) {
	cfg := config.DefaultConfig()
...
func TestEconomyNegotiationFormValidatesRoundsAndDiscount(t *testing.T) {
	cfg := config.DefaultConfig()
...
func TestEconomyEscrowFormsExposeDurationsAndValidation(t *testing.T) {
	cfg := config.DefaultConfig()
...
func TestEconomyOnChainFormValidatesModeDepthAndRetries(t *testing.T) {
	cfg := config.DefaultConfig()
...
func TestEconomyPricingFormValidatesDiscounts(t *testing.T) {
	cfg := config.DefaultConfig()
