...
func TestWave32CronFormWiresDefaultsAndValidation(t *testing.T) {
...
func TestWave32BackgroundFormWiresFieldsAndValidators(t *testing.T) {
	cfg := config.DefaultConfig()
...
func TestWave32WorkflowFormWiresFieldsAndValidation(t *testing.T) {
	cfg := config.DefaultConfig()
...
func TestWave32RunLedgerFormWiresFieldsAndValidators(t *testing.T) {
	cfg := config.DefaultConfig()
...
func TestWave32ProvenanceFormWiresFieldsAndValidators(t *testing.T) {
	cfg := config.DefaultConfig()
