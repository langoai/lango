...
func TestWave31GraphFormWiresFieldsAndValidators(t *testing.T) {
...
func TestWave31LibrarianFormWiresProviderModelAndValidators(t *testing.T) {
	cfg := config.DefaultConfig()
...
func TestWave31ObservationalMemoryFormWiresLimitsAndProviderReload(t *testing.T) {
	cfg := config.DefaultConfig()
	cfg.Agent.Provider = "primary"
	cfg.Providers = map[string]config.ProviderConfig{
		"primary": {Type: types.ProviderOpenAI},
...
func TestWave31EmbeddingFormWiresProviderOptionsValidationAndReload(t *testing.T) {
	cfg := config.DefaultConfig()
	cfg.Providers = map[string]config.ProviderConfig{
...
func TestWave31AutoAdjustFormWiresVisibilityAndRatioValidators(t *testing.T) {
	cfg := config.DefaultConfig()
...
func TestWave31ContextBudgetFormFormatsAllocationsAndValidatesRatios(t *testing.T) {
	cfg := config.DefaultConfig()
