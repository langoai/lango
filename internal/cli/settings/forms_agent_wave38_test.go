...
func TestWave38AgentFormWiresProviderModelBranchesAndReloads(t *testing.T) {
...
func TestWave38AgentFormFallsBackToManualModelFields(t *testing.T) {
	cfg := config.DefaultConfig()
...
func TestWave38MultiAgentFormWiresDefaultsVisibilityAndValidation(t *testing.T) {
	cfg := config.DefaultConfig()
...
func TestWave38MultiAgentFormPreservesExplicitOrchestrationValues(t *testing.T) {
...
func TestWave38A2AAndPaymentFormsWireFieldsAndValidation(t *testing.T) {
	cfg := config.DefaultConfig()
