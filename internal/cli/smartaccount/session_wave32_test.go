...
func TestWave32SessionCreateJSONRunsCleanup(t *testing.T) {
...
func TestWave32SessionListEmptyJSONRunsCleanup(t *testing.T) {
...
func TestWave32SessionListHandlesShortTableValues(t *testing.T) {
	original := loadSessionList
	loadSessionList = func(_ BootLoader) ([]sessionListEntry, func(), error) {
...
func TestWave32SessionRevokeRejectsAllWithSessionIDBeforeExecute(t *testing.T) {
...
func TestWave32SessionRevokeRunsCleanupAfterSuccess(t *testing.T) {
	original := executeSessionRevoke
	cleanupCalled := false
...
func TestWave32SessionRevokePropagatesErrorWithoutCleanup(t *testing.T) {
	original := executeSessionRevoke
	cleanupCalled := false
