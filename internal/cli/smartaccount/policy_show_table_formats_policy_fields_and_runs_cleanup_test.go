...
func TestPolicyShowTableFormatsPolicyFieldsAndRunsCleanup(t *testing.T) {
	cleanupCalled := false
...
func TestPolicyShowJSONFormatsPayloadAndRunsCleanup(t *testing.T) {
	cleanupCalled := false
	installPolicyShowTableFormatsPolicyFieldsAndRunsCleanupPolicyShowSeam(t, func(_ BootLoader) (policyShowInfo, func(), error) {
		return policyShowInfo{
			Account:          "0x1234abcd5678ef901234abcdef567890abcdef12",
...
func TestPolicyShowRejectsInvalidOutputBeforeLoadingPolicy(t *testing.T) {
	called := false
	installPolicyShowTableFormatsPolicyFieldsAndRunsCleanupPolicyShowSeam(t, func(_ BootLoader) (policyShowInfo, func(), error) {
		called = true
...
func TestPolicyShowPropagatesSeamErrorWithoutCleanup(t *testing.T) {
	cleanupCalled := false
	installPolicyShowTableFormatsPolicyFieldsAndRunsCleanupPolicyShowSeam(t, func(_ BootLoader) (policyShowInfo, func(), error) {
...
func TestPolicySetTableFormatsReturnedLimitsAndRunsCleanup(t *testing.T) {
	cleanupCalled := false
...
func TestPolicySetPropagatesNoLimitValidationFromSeam(t *testing.T) {
	cleanupCalled := false
	installPolicyShowTableFormatsPolicyFieldsAndRunsCleanupPolicySetSeam(t, func(_ BootLoader, maxTx, daily, monthly string) (policySetResult, func(), error) {
...
func TestUpdatePolicyLimitsValidatesLimitsBeforeBootstrapping(t *testing.T) {
	tests := []struct {
		name      string
		maxTx     string
		daily     string
...
func TestPolicySetPropagatesSeamErrorWithoutCleanup(t *testing.T) {
	cleanupCalled := false
	installPolicyShowTableFormatsPolicyFieldsAndRunsCleanupPolicySetSeam(t, func(_ BootLoader, maxTx, daily, monthly string) (policySetResult, func(), error) {
		assert.Equal(t, "100", maxTx)
		assert.Empty(t, daily)
...
func TestParsePolicyLimitAcceptsIntegersAndRejectsInvalidAmounts(t *testing.T) {
...
func TestValueOrNAFormatsEmptyAndPresentValues(t *testing.T) {
	assert.Equal(t, "n/a", valueOrNA(""))
	assert.Equal(t, "0", valueOrNA("0"))
	assert.Equal(t, "1000000000000000000", valueOrNA("1000000000000000000"))
}

func installPolicyShowTableFormatsPolicyFieldsAndRunsCleanupPolicyShowSeam(
	t *testing.T,
...
func installPolicyShowTableFormatsPolicyFieldsAndRunsCleanupPolicySetSeam(
	t *testing.T,
