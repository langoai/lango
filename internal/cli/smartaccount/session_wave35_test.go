...
func TestWave35SessionExecutionHelpersWrapBootstrapErrors(t *testing.T) {
...
func TestWave35SessionExecutionHelpersCloseBootOnInitFailure(t *testing.T) {
	tests := []struct {
		name string
...
func TestWave35ExecuteSessionCreateValidatesInputsAfterInitializingDeps(t *testing.T) {
	tests := []struct {
		name      string
		targets   []string
		limit     string
...
func TestWave35ExecuteSessionCreateReturnsResultAndCleanup(t *testing.T) {
...
func TestWave35ExecuteSessionRevokeBranchesWithoutLiveChainRPC(t *testing.T) {
	t.Run("all succeeds with empty store", func(t *testing.T) {
		message, cleanup, err := executeSessionRevoke(newWave35SessionBootLoader(t), true, "")
		require.NoError(t, err)
		require.NotNil(t, cleanup)
		defer cleanup()
	...
	t.Run("single missing session wraps store error", func(t *testing.T) {
		message, cleanup, err := executeSessionRevoke(newWave35SessionBootLoader(t), false, "missing-session")
		require.Error(t, err)
...
func TestWave35BuildSessionListEntriesMapsRealSessionStatus(t *testing.T) {
	now := time.Now()
...
func TestWave35SessionListStatusMappingAndTableFormatting(t *testing.T) {
...
func TestWave35SessionRevokeRejectsTooManyArgsBeforeExecute(t *testing.T) {
...
func TestWave35SessionCreateRunsCleanupWhenTableFlushFails(t *testing.T) {
...
func TestWave35TablePreviewBoundaries(t *testing.T) {
	tests := []struct {
		name      string
		value     string
		prefixLen int
...
func newWave35SessionBootLoader(t *testing.T) BootLoader {
	t.Helper()
	...
	client := enttest.Open(t, "sqlite3", "file:"+wave35SQLiteName(t.Name())+"?mode=memory&_fk=1")
...
func wave35SQLiteName(name string) string {
