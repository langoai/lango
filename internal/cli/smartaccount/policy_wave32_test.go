...
func TestWave32PolicyShowRejectsInvalidOutputBeforeLoading(t *testing.T) {
...
func TestWave32PolicyShowNoPolicyTableRunsCleanup(t *testing.T) {
	original := loadPolicyShowInfo
	cleanupCalled := false
	loadPolicyShowInfo = func(_ BootLoader) (policyShowInfo, func(), error) {
...
func TestWave32PolicyShowJSONRunsCleanup(t *testing.T) {
	original := loadPolicyShowInfo
	cleanupCalled := false
	loadPolicyShowInfo = func(_ BootLoader) (policyShowInfo, func(), error) {
		return policyShowInfo{
...
func TestWave32PolicyShowPropagatesLoadErrorWithoutCleanup(t *testing.T) {
	original := loadPolicyShowInfo
	cleanupCalled := false
	loadPolicyShowInfo = func(_ BootLoader) (policyShowInfo, func(), error) {
...
func TestWave32PolicySetPassesFlagsPrintsPartialResultAndRunsCleanup(t *testing.T) {
...
func TestWave32PolicySetRejectsPositionalArgsBeforeUpdating(t *testing.T) {
	original := updatePolicyLimits
	called := false
...
func TestWave32PolicySetPropagatesUpdateErrorWithoutCleanup(t *testing.T) {
	original := updatePolicyLimits
	cleanupCalled := false
	updatePolicyLimits = func(_ BootLoader, _, _, _ string) (policySetResult, func(), error) {
...
func TestWave32ValueOrNA(t *testing.T) {
