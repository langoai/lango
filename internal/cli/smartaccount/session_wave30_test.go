...
func TestWave30SessionCreateRejectsInvalidOutputBeforeLoading(t *testing.T) {
...
func TestWave30SessionCreateRunsCleanupAfterSuccessfulOutput(t *testing.T) {
	original := executeSessionCreate
	cleanupCalled := false
...
func TestWave30SessionCreatePropagatesExecutorErrorWithoutCleanup(t *testing.T) {
	original := executeSessionCreate
	cleanupCalled := false
	executeSessionCreate = func(_ BootLoader, _, _ []string, _, _ string) (sessionCreateResult, func(), error) {
...
func TestWave30SessionListFormatsParentAndRunsCleanup(t *testing.T) {
...
func TestWave30SessionListPropagatesLoadError(t *testing.T) {
	original := loadSessionList
	loadSessionList = func(_ BootLoader) ([]sessionListEntry, func(), error) {
...
func TestWave30SessionRevokeRequiresIDUnlessAllAndDoesNotExecute(t *testing.T) {
...
func TestWave30SessionRevokePropagatesExecutorError(t *testing.T) {
	original := executeSessionRevoke
