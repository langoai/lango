...
var workflowRootCommandConstructsExpectedSubcommandsWorkflowSeamMu sync.Mutex

func TestWorkflowRootCommandConstructsExpectedSubcommands(t *testing.T) {
...
func TestWorkflowRunRejectsInvalidWorkflowBeforeBootstrap(t *testing.T) {
...
func TestWorkflowValidateJSONReportsParseErrorToCommandWriter(t *testing.T) {
...
func TestWorkflowRunFormatsExecutionErrorAndTruncatedStepOutput(t *testing.T) {
	workflowPath := writeWorkflowFile(t, `
name: Daily Report
steps:
  - id: collect
...
func TestWorkflowCancelPropagatesErrorWithoutOutput(t *testing.T) {
	workflowRootCommandConstructsExpectedSubcommandsWorkflowSeamMu.Lock()
...
func TestWorkflowReadCommandsReturnBootstrapErrors(t *testing.T) {
