...
func TestWave47WorkflowRunCommandValidationBranchesAvoidBootstrap(t *testing.T) {
	tests := []struct {
		name        string
		args        []string
		workflowYML string
...
func TestWave47WorkflowRunScheduleRegistrationFailureBranches(t *testing.T) {
...
func TestWave47WorkflowRunDirectExecutionBranches(t *testing.T) {
	workflowPath := writeWorkflowFile(t, `
name: direct-report
steps:
  - id: collect
...
func TestWave47WorkflowReadAndCancelOutputBranches(t *testing.T) {
...
type wave47CronStore struct {
	createCalls int
}

func (s *wave47CronStore) Create(context.Context, cron.Job) error {
	s.createCalls++
	return nil
}

func (s *wave47CronStore) Get(context.Context, string) (*cron.Job, error) {
	return nil, errors.New("not implemented")
}

func (s *wave47CronStore) GetByName(context.Context, string) (*cron.Job, error) {
	return nil, errors.New("not implemented")
}

func (s *wave47CronStore) List(context.Context) ([]cron.Job, error) {
	return nil, errors.New("not implemented")
}

func (s *wave47CronStore) ListEnabled(context.Context) ([]cron.Job, error) {
	return nil, errors.New("not implemented")
}

func (s *wave47CronStore) Update(context.Context, cron.Job) error {
	return errors.New("not implemented")
}

func (s *wave47CronStore) Upsert(context.Context, cron.Job) (*cron.Job, bool, error) {
	return nil, false, errors.New("not implemented")
}

func (s *wave47CronStore) Delete(context.Context, string) error {
	return errors.New("not implemented")
}

func (s *wave47CronStore) SaveHistory(context.Context, cron.HistoryEntry) error {
	return errors.New("not implemented")
}

func (s *wave47CronStore) ListHistory(context.Context, string, int) ([]cron.HistoryEntry, error) {
	return nil, errors.New("not implemented")
}

func (s *wave47CronStore) ListAllHistory(context.Context, int) ([]cron.HistoryEntry, error) {
	return nil, errors.New("not implemented")
}
