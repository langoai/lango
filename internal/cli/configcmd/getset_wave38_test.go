...
func TestWave38FormatPlainScalarAndReflectionValues(t *testing.T) {
...
func TestWave38RedactConfigGetValueCoversReflectPointersMapsAndSlices(t *testing.T) {
	type nested struct {
...
func TestWave38RedactConfigGetValueJSONRedactsNestedGenericValues(t *testing.T) {
...
func TestWave38ResolveAndSetInvalidPathsReturnDiscoveryHints(t *testing.T) {
...
func TestWave38SetFieldRejectsInvalidScalarInputs(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := setField(tt.field, tt.rawValue, "wave38.path")
			if err == nil {
				t.Fatal("expected error")
			}
...
func TestWave38ConfigSetRejectsInvalidScalarBeforeSave(t *testing.T) {
	cfg := config.DefaultConfig()
	saveCalled := false
	cmd := NewSetCmd(
