...
func TestWave29EnsureDataDirResolvesDefaultsAndPreservesExplicitPaths(t *testing.T) {
	t.Parallel()
...
func TestWave29DetectEncryptionHandlesMissingPlainAndLegacyHeaders(t *testing.T) {
	t.Parallel()
...
func TestWave29UnwrapOrCreateMasterKeyBranches(t *testing.T) {
	t.Parallel()
...
func TestWave29MigrateEnvelopeRejectsBrokerAndPendingRekeyBranches(t *testing.T) {
	t.Parallel()
...
func TestWave29DeriveKeyPhasesNoopAndPopulateResult(t *testing.T) {
	t.Parallel()
