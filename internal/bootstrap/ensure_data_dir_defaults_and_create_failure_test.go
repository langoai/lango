...
func TestEnsureDataDirDefaultsAndCreateFailure(t *testing.T) {
...
func TestLoadEnvelopeFileBranches(t *testing.T) {
...
func TestDetectEncryptionRejectsLegacyEncryptedHeaders(t *testing.T) {
	dir := t.TempDir()
...
func TestAcquireCredentialSetsFirstRunGuessAndWrapsErrors(t *testing.T) {
...
func TestOpenDatabaseDirectAndBrokerBranches(t *testing.T) {
	...
	openErrBroker := &ensureDataDirDefaultsAndCreateFailureBroker{openErr: errors.New("open failed")}
	...
	successBroker := &ensureDataDirDefaultsAndCreateFailureBroker{}
...
func TestLoadSecurityStateDirectAndBrokerBranches(t *testing.T) {
	...
	broker := &ensureDataDirDefaultsAndCreateFailureBroker{
	...
	state = &State{
		Broker:   &ensureDataDirDefaultsAndCreateFailureBroker{loadSecurityStateErr: errors.New("load failed")},
...
func TestLoadProfileCreatesDefaultAndLoadsForcedProfile(t *testing.T) {
	client, rawDB, crypto := ensureDataDirDefaultsAndCreateFailureProfileDependencies(t)
...
func ensureDataDirDefaultsAndCreateFailureProfileDependencies(t *testing.T) (*ent.Client, *sql.DB, security.CryptoProvider) {
	t.Helper()
...
type ensureDataDirDefaultsAndCreateFailureBroker struct {
	stubBrokerClient
...
func (b *ensureDataDirDefaultsAndCreateFailureBroker) OpenDB(_ context.Context, req storagebroker.OpenDBRequest) (storagebroker.OpenDBResult, error) {
...
func (b *ensureDataDirDefaultsAndCreateFailureBroker) LoadSecurityState(context.Context) (storagebroker.LoadSecurityStateResult, error) {
...
func (b *ensureDataDirDefaultsAndCreateFailureBroker) StoreSalt(_ context.Context, salt []byte) error {
	b.storedSalt = append([]byte(nil), salt...)
	return nil
}

func (b *ensureDataDirDefaultsAndCreateFailureBroker) StoreChecksum(_ context.Context, checksum []byte) error {
	b.storedChecksum = append([]byte(nil), checksum...)
	return nil
}

func (b *ensureDataDirDefaultsAndCreateFailureBroker) Close(context.Context) error {
	b.closeCalls++
	return nil
}
