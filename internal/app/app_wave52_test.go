...
func TestWave52InitP2PEarlyExitBranchesAvoidNetworkState(t *testing.T) {
	t.Parallel()
...
func TestWave52NetworkModuleP2PEnabledWithoutPaymentReportsPaymentRequired(t *testing.T) {
	t.Parallel()
...
func TestWave52ParseEscrowExecutionInputReportsRequiredFieldErrors(t *testing.T) {
	t.Parallel()
	...
	tests := []struct {
		...
		},
		{
			...
			give: map[string]interface{}{
				"escrow_buyer_did":  "did:lango:buyer",
				"escrow_seller_did": "did:lango:seller",
				"escrow_reason":     "wave52 execution",
...
func TestWave52WireBudgetManagerInvalidAllocationReturnsWithoutAdapter(t *testing.T) {
	t.Parallel()
