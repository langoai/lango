...
func TestInitAgentRegistryIgnoresInvalidUserAgentsDir(t *testing.T) {
	t.Parallel()
...
func TestNetworkModuleInitAllNetworkFeaturesDisabled(t *testing.T) {
	t.Parallel()
	...
	assert.Nil(t, initAgentRegistryIgnoresInvalidUserAgentsDirCatalogEntry(result.CatalogEntries, "workspace"))
}

func TestCreateSkillRejectsMalformedJSONBeforeDependencies(t *testing.T) {
	t.Parallel()
	...
	tests := []struct {
	...
	}{
		{
			name: "definition",
			params: map[string]interface{}{
				"name":        "runChatStartErrorStopsBeforeSessionAndTui6-json",
		...
		},
		{
			name: "parameters",
			params: map[string]interface{}{
				"name":        "runChatStartErrorStopsBeforeSessionAndTui6-params",
...
func TestInitP2PRejectsInvalidListenAddressWithoutRuntimeStartup(t *testing.T) {
	t.Parallel()
...
func TestPathInsideDirRejectsMixedAbsoluteRelativeInputs(t *testing.T) {
	t.Parallel()
...
func initAgentRegistryIgnoresInvalidUserAgentsDirCatalogEntry(entries []appinit.CatalogEntry, category string) *appinit.CatalogEntry {
	for i := range entries {
