...
func TestWave34InitSecurityRPCWithEntStoreWiresStores(t *testing.T) {
	t.Parallel()
...
func TestWave34BuildProvenanceAgentOptionsHandlesMissingMetadata(t *testing.T) {
	t.Parallel()
...
func TestWave34InitP2PEarlyExitBranchesAvoidRuntimeStartup(t *testing.T) {
	t.Parallel()
