...
func TestBuildMetaTools_IncludesExecutePartialSettlement(t *testing.T) {
	tools := buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, receipts.NewStore(), nil, nil, &fakePartialSettlementExecutionRuntime{})
...
func TestExecutePartialSettlement_ApprovedPathReturnsCanonicalReceipt(t *testing.T) {
	...
	tool := findTool(buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, store, nil, nil, runtime), "execute_partial_settlement")
	require.NotNil(t, tool)
...
func TestExecutePartialSettlement_RejectsMissingOrInvalidPartialHint(t *testing.T) {
	...
	for _, tt := range cases {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			tool := findTool(buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, store, nil, nil, &fakePartialSettlementExecutionRuntime{}), "execute_partial_settlement")
			require.NotNil(t, tool)
