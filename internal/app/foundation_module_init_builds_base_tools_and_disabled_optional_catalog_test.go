...
func TestFoundationModuleInitBuildsBaseToolsAndDisabledOptionalCatalog(t *testing.T) {
	t.Parallel()
...
func TestIntelligenceModuleInitCollectsUnavailableDependencyStatuses(t *testing.T) {
	...
	result, err := mod.Init(context.Background(), staticResolver{
		...
		appinit.ProvidesBaseTools: []*agent.Tool{{Name: "foundationModuleInitBuildsBaseToolsAndDisabledOptionalCatalog_base"}},
	})
	require.NoError(t, err)
	require.NotNil(t, result)
	...
	statuses := foundationModuleInitBuildsBaseToolsAndDisabledOptionalCatalogFeatureStatusesByName(values.FeatureStatuses)
...
func TestAutomationModuleInitKeepsControlPlaneWhenStoresAreUnavailable(t *testing.T) {
	t.Parallel()
	...
	assert.Nil(t, foundationModuleInitBuildsBaseToolsAndDisabledOptionalCatalogCatalogEntry(result.CatalogEntries, "cron"))
	assert.Nil(t, foundationModuleInitBuildsBaseToolsAndDisabledOptionalCatalogCatalogEntry(result.CatalogEntries, "workflow"))
	assert.NotNil(t, findTool(result.Tools, "agent_spawn"))
	assert.NotNil(t, findTool(result.Tools, "task_create"))
}

func TestNetworkModuleInitPaymentDependencyDisabledBranches(t *testing.T) {
	t.Parallel()
...
func TestExtensionModuleInitObservabilityEnabledWithoutPersistentStore(t *testing.T) {
	t.Parallel()
	...
	assert.Nil(t, foundationModuleInitBuildsBaseToolsAndDisabledOptionalCatalogCatalogEntry(result.CatalogEntries, "observability"))
}

func foundationModuleInitBuildsBaseToolsAndDisabledOptionalCatalogModuleConfig(t *testing.T) *config.Config {
	t.Helper()
...
func foundationModuleInitBuildsBaseToolsAndDisabledOptionalCatalogFeatureStatusesByName(collector *StatusCollector) map[string]types.FeatureStatus {
	if collector == nil {
		return nil
	}
...
func foundationModuleInitBuildsBaseToolsAndDisabledOptionalCatalogCatalogEntry(
