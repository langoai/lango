...
func TestBuildMetaTools_IncludesExecuteSettlement(t *testing.T) {
	tools := buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, receipts.NewStore(), nil, &fakeSettlementExecutionRuntime{})
...
func TestExecuteSettlement_ApprovedPathReturnsCanonicalReceipt(t *testing.T) {
	...
	tool := findTool(buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, store, nil, runtime), "execute_settlement")
	require.NotNil(t, tool)
...
func TestExecuteSettlement_RejectsWhenProgressionIsNotApprovedForSettlement(t *testing.T) {
	...
	tool := findTool(buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, store, nil, &fakeSettlementExecutionRuntime{}), "execute_settlement")
	require.NotNil(t, tool)
...
func TestExecuteSettlement_PropagatesRuntimeFailure(t *testing.T) {
	...
	tool := findTool(buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, store, nil, &fakeSettlementExecutionRuntime{err: errors.New("rpc timeout")}), "execute_settlement")
	require.NotNil(t, tool)
