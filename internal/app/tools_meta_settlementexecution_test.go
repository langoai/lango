...
func TestBuildMetaTools_IncludesExecuteSettlement(t *testing.T) {
	tools := buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, receipts.NewStore(), nil, &fakeSettlementExecutionRuntime{}, nil, nil)
...
func TestExecuteSettlement_ApprovedPathReturnsCanonicalReceipt(t *testing.T) {
	...
	tool := findTool(buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, store, nil, runtime, nil, nil), "execute_settlement")
	require.NotNil(t, tool)
...
func TestExecuteSettlement_RejectsWhenProgressionIsNotApprovedForSettlement(t *testing.T) {
	...
	tool := findTool(buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, store, nil, &fakeSettlementExecutionRuntime{}, nil, nil), "execute_settlement")
	require.NotNil(t, tool)
...
func TestExecuteSettlement_PropagatesRuntimeFailure(t *testing.T) {
	...
	tool := findTool(buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, store, nil, &fakeSettlementExecutionRuntime{err: errors.New("rpc timeout")}, nil, nil), "execute_settlement")
	require.NotNil(t, tool)
