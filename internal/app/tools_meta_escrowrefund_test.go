...
func TestBuildMetaTools_IncludesRefundEscrowSettlement(t *testing.T) {
	tools := buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, receipts.NewStore(), nil, nil, nil, nil, &fakeEscrowRefundRuntime{})
...
func TestRefundEscrowSettlement_FundedReviewNeededPathReturnsCanonicalReceipt(t *testing.T) {
	...
	tool := findTool(buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, store, nil, nil, nil, nil, runtime), "refund_escrow_settlement")
	require.NotNil(t, tool)
...
func TestRefundEscrowSettlement_RejectsWhenEscrowOrSettlementStateIsWrong(t *testing.T) {
	...
	for _, tt := range cases {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			tool := findTool(buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, store, nil, nil, nil, nil, &fakeEscrowRefundRuntime{}), "refund_escrow_settlement")
			require.NotNil(t, tool)
...
func TestRefundEscrowSettlement_PropagatesRuntimeFailure(t *testing.T) {
	...
	tool := findTool(buildMetaToolsWithRuntimes(nil, nil, nil, config.SkillConfig{}, nil, store, nil, nil, nil, nil, &fakeEscrowRefundRuntime{err: errors.New("refund failed")}), "refund_escrow_settlement")
	require.NotNil(t, tool)
