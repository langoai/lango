...
func TestWave53BrowserNewDefaultsSessionTimeoutAndInitializesSessions(t *testing.T) {
	t.Parallel()
...
func TestWave53BrowserSessionMethodsReturnNotFoundWithoutStartingBrowser(t *testing.T) {
	t.Parallel()
...
func TestWave53BrowserNilPageOperationsRecoverRodPanic(t *testing.T) {
	t.Parallel()
