...
func TestStartRequiresMessageHandler(t *testing.T) {
	t.Parallel()
...
func TestEditMessageRetriesPlainTextWhenMarkdownFails(t *testing.T) {
	t.Parallel()
...
func TestHandleUpdateMapsReplyAndMediaBranches(t *testing.T) {
	t.Parallel()
...
func TestHandleUpdateFallsBackToTypingAndSendErrorWhenPlaceholderFails(t *testing.T) {
	t.Parallel()
