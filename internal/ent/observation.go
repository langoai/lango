...
func (*Observation) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case observation.FieldContentCiphertext, observation.FieldContentNonce:
			values[i] = new([]byte)
		case observation.FieldContentKeyVersion, observation.FieldTokenCount, observation.FieldSourceStartIndex, observation.FieldSourceEndIndex:
