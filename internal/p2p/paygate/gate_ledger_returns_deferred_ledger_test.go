...
func TestGateLedgerReturnsDeferredLedger(t *testing.T) {
	t.Parallel()
...
func TestParseAuthorizationAcceptsStringAndJSONNumberFields(t *testing.T) {
	t.Parallel()
...
func TestParseAuthorizationReportsFieldSpecificErrors(t *testing.T) {
	t.Parallel()
...
func TestHelperExtractorsEdges(t *testing.T) {
	t.Parallel()
...
func TestDeferredLedgerCleanupRemovesOnlySettledEntries(t *testing.T) {
	t.Parallel()
