...
func TestWave25CallerABIAndLocalReadErrors(t *testing.T) {
	t.Parallel()
...
func TestWave25CallerReadUnpacksDeterministicABIResult(t *testing.T) {
	t.Parallel()
	...
	caller := wave25CallerWithRPC(t, &wave25ContractAPI{
...
func TestWave25CallerWriteLocalErrors(t *testing.T) {
	t.Parallel()
...
func TestWave25ExtractRevertReason(t *testing.T) {
	t.Parallel()

	errorData := wave25SolidityErrorData(t, "Caller is not the owner")
	...
	tests := []struct {
	...
	}{
		{
			...
			err:  wave25DataError{data: errorData},
		...
		},
		{
			...
			err:  wave25DataError{data: 12345},
			want: "",
		},
		{
...
func TestWave25WaitForReceiptTimeoutAndContext(t *testing.T) {
	t.Parallel()
	...
	t.Run("times out without waiting for polling delay", func(t *testing.T) {
		...
		caller := wave25CallerWithRPC(t, &wave25ReceiptAPI{})
...
type wave25Wallet struct {
	addressErr error
}

func (w *wave25Wallet) Address(context.Context) (string, error) {
	if w.addressErr != nil {
		return "", w.addressErr
	}
...
func (w *wave25Wallet) Balance(context.Context) (*big.Int, error) {
	return nil, errors.New("not implemented")
}

func (w *wave25Wallet) SignTransaction(context.Context, []byte) ([]byte, error) {
	return nil, errors.New("not implemented")
}

func (w *wave25Wallet) SignMessage(context.Context, []byte) ([]byte, error) {
	return nil, errors.New("not implemented")
}

func (w *wave25Wallet) PublicKey(context.Context) ([]byte, error) {
	return nil, errors.New("not implemented")
}

type wave25DataError struct {
	data interface{}
}

func (e wave25DataError) Error() string {
	return "execution reverted"
}

func (e wave25DataError) ErrorData() interface{} {
	return e.data
}

type wave25ReceiptAPI struct {
	receipt *types.Receipt
}

func (api *wave25ReceiptAPI) GetTransactionReceipt(
	context.Context,
	common.Hash,
) (*types.Receipt, error) {
...
type wave25ContractAPI struct {
	expectedTo   common.Address
	expectedData []byte
	output       hexutil.Bytes
}

func (api *wave25ContractAPI) Call(
	_ context.Context,
...
func wave25RPCAddress(value interface{}) (string, error) {
	switch v := value.(type) {
	case common.Address:
		return v.Hex(), nil
	case string:
...
func wave25RPCBytes(value interface{}) ([]byte, error) {
	switch v := value.(type) {
	case hexutil.Bytes:
		return []byte(v), nil
	case []byte:
...
func wave25CallerWithRPC(t *testing.T, api interface{}) *Caller {
	t.Helper()
...
func wave25SolidityErrorData(t *testing.T, reason string) string {
	t.Helper()
