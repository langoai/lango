...
func TestCallerWriteSubmitsSignedTransactionAndReturnsReceipt(t *testing.T) {
	t.Parallel()
	...
	api := &callerWriteSubmitsSignedTransactionAndReturnsReceiptWriteAPI{
		expectedFrom:  from,
		expectedTo:    to,
	...
	caller := callerWriteSubmitsSignedTransactionAndReturnsReceiptCallerWithRPC(t, api, &callerWriteSubmitsSignedTransactionAndReturnsReceiptSigningWallet{key: key})
	caller.maxRetries = 1
...
func TestCallerWriteReplaysGasEstimateFailureForRevertReason(t *testing.T) {
	t.Parallel()
	...
	api := &callerWriteSubmitsSignedTransactionAndReturnsReceiptWriteAPI{
		...
		callErr:      callerAbiAndLocalReadErrorsDataError{data: callerAbiAndLocalReadErrorsSolidityErrorData(t, "transfer is paused")},
	}
	caller := callerWriteSubmitsSignedTransactionAndReturnsReceiptCallerWithRPC(t, api, &callerWriteSubmitsSignedTransactionAndReturnsReceiptSigningWallet{key: key})
...
func TestReplayForRevertReasonUsesProvidedBlockNumber(t *testing.T) {
	t.Parallel()

	api := &callerWriteSubmitsSignedTransactionAndReturnsReceiptWriteAPI{
		callErr: callerAbiAndLocalReadErrorsDataError{data: callerAbiAndLocalReadErrorsSolidityErrorData(t, "block scoped revert")},
	}
	caller := callerWriteSubmitsSignedTransactionAndReturnsReceiptCallerWithRPC(t, api, &callerWriteSubmitsSignedTransactionAndReturnsReceiptSigningWallet{})
...
type callerWriteSubmitsSignedTransactionAndReturnsReceiptSigningWallet struct {
	key *ecdsa.PrivateKey
	err error
}

func (w *callerWriteSubmitsSignedTransactionAndReturnsReceiptSigningWallet) Address(context.Context) (string, error) {
	if w.err != nil {
		return "", w.err
	}
	if w.key == nil {
...
func (w *callerWriteSubmitsSignedTransactionAndReturnsReceiptSigningWallet) Balance(context.Context) (*big.Int, error) {
	return nil, errors.New("not implemented")
}

func (w *callerWriteSubmitsSignedTransactionAndReturnsReceiptSigningWallet) SignTransaction(_ context.Context, digest []byte) ([]byte, error) {
	if w.err != nil {
		return nil, w.err
	}
	if w.key == nil {
...
func (w *callerWriteSubmitsSignedTransactionAndReturnsReceiptSigningWallet) SignMessage(context.Context, []byte) ([]byte, error) {
	return nil, errors.New("not implemented")
}

func (w *callerWriteSubmitsSignedTransactionAndReturnsReceiptSigningWallet) PublicKey(context.Context) ([]byte, error) {
	return nil, errors.New("not implemented")
}

type callerWriteSubmitsSignedTransactionAndReturnsReceiptWriteAPI struct {
...
func (api *callerWriteSubmitsSignedTransactionAndReturnsReceiptWriteAPI) GetTransactionCount(
	_ context.Context,
...
func (api *callerWriteSubmitsSignedTransactionAndReturnsReceiptWriteAPI) EstimateGas(
	_ context.Context,
...
func (api *callerWriteSubmitsSignedTransactionAndReturnsReceiptWriteAPI) GetBlockByNumber(
	_ context.Context,
	block string,
	_ bool,
) (*types.Header, error) {
...
func (api *callerWriteSubmitsSignedTransactionAndReturnsReceiptWriteAPI) SendRawTransaction(
	_ context.Context,
	raw hexutil.Bytes,
) (common.Hash, error) {
...
func (api *callerWriteSubmitsSignedTransactionAndReturnsReceiptWriteAPI) GetTransactionReceipt(
	_ context.Context,
	hash common.Hash,
) (*types.Receipt, error) {
...
func (api *callerWriteSubmitsSignedTransactionAndReturnsReceiptWriteAPI) Call(
	_ context.Context,
	msg map[string]interface{},
	block string,
) (hexutil.Bytes, error) {
...
func (api *callerWriteSubmitsSignedTransactionAndReturnsReceiptWriteAPI) assertCallMessage(msg map[string]interface{}) error {
	if api.expectedFrom != (common.Address{}) {
		from, err := callerAbiAndLocalReadErrorsRPCAddress(msg["from"])
		if err != nil {
			return err
		}
	...
	if api.expectedValue != nil {
		value, err := callerWriteSubmitsSignedTransactionAndReturnsReceiptRPCBigInt(msg["value"])
		if err != nil {
			return err
		}
...
func callerWriteSubmitsSignedTransactionAndReturnsReceiptRPCBigInt(value interface{}) (*big.Int, error) {
	switch v := value.(type) {
	case nil:
...
func callerWriteSubmitsSignedTransactionAndReturnsReceiptCallerWithRPC(t *testing.T, api interface{}, wallet *callerWriteSubmitsSignedTransactionAndReturnsReceiptSigningWallet) *Caller {
	t.Helper()
