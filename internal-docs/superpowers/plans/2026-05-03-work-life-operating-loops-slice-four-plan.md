# Work And Life Operating Loops Slice 4 Implementation Plan
...
**Goal:** Land the first practical slice of Slice 4 by adding an operator-facing loop and agenda projection on top of existing durable missions, pending inquiries, dead letters, and deterministic follow-up signals, without pretending unsupported calendar or inbox integrations already exist.

**Architecture:** Slice 4 remains projection-first. It does not add a new durable loop database table in the first slice. Instead it adds a deterministic loop model and loop projector over existing sources, then surfaces those loops in Mission Control as a compact agenda/open-loops layer.
...
- Create: `openspec/changes/work-life-operating-loops-slice-four/proposal.md`
- Create: `openspec/changes/work-life-operating-loops-slice-four/design.md`
- Create: `openspec/changes/work-life-operating-loops-slice-four/tasks.md`
- Create: `openspec/changes/work-life-operating-loops-slice-four/specs/mission-control-tui/spec.md`
- Modify: `README.md`
...
### Task 1: Create the Slice 4 OpenSpec Change
...
```bash
openspec validate work-life-operating-loops-slice-four --strict
```

Expected:

```text
Change 'work-life-operating-loops-slice-four' is valid
```
...
- [ ] **Step 1: Audit landed Slice 4 behavior before editing docs**
...
- [ ] **Step 3: Run final Slice 4 review**

Before claiming Slice 4 complete:
