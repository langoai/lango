# Mission Control Wave 1 Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Land Wave 1 Mission Control as the default `lango` cockpit surface using background tasks, shared pending approvals, learning suggestions, and optional RunLedger/AgentRun readers without introducing durable mission persistence.
...
- Create: `openspec/changes/2026-05-02-mission-control-wave-one/proposal.md`
- Create: `openspec/changes/2026-05-02-mission-control-wave-one/design.md`
- Create: `openspec/changes/2026-05-02-mission-control-wave-one/tasks.md`
- Create: `openspec/changes/2026-05-02-mission-control-wave-one/specs/mission-control-tui/spec.md`
- Create: `openspec/changes/2026-05-02-mission-control-wave-one/specs/cockpit-shell/spec.md`
- Create: `openspec/changes/2026-05-02-mission-control-wave-one/specs/cockpit-pages/spec.md`
- Create: `openspec/changes/2026-05-02-mission-control-wave-one/specs/interactive-tui-chat/spec.md`
- Create: `openspec/changes/2026-05-02-mission-control-wave-one/specs/tui-approval-tiers/spec.md`
- Modify: `README.md`
...
### Task 1: Create the OpenSpec Change for Wave 1
...
Create the Wave 1 change directory and add proposal/design/tasks docs that mirror the approved internal design:

- Mission Control is the default `lango` surface
- `lango chat` remains the direct chat fallback
- Wave 1 is projection plus producer hardening, not a mission domain engine
...
- `openspec/changes/2026-05-02-mission-control-wave-one/specs/mission-control-tui/spec.md`
...
- `openspec/changes/2026-05-02-mission-control-wave-one/specs/cockpit-shell/spec.md`
- `openspec/changes/2026-05-02-mission-control-wave-one/specs/cockpit-pages/spec.md`
- `openspec/changes/2026-05-02-mission-control-wave-one/specs/interactive-tui-chat/spec.md`
- `openspec/changes/2026-05-02-mission-control-wave-one/specs/tui-approval-tiers/spec.md`
...
Confirm the change does not claim any Wave 2 behavior:
...
- other timeline-relevant EventBus events that already exist in Wave 1
...
- [ ] **Step 3: Run subagent review before moving to the next wave**
...
Do not start Wave 2 until the review is addressed and accepted.
...
- `spec: add mission control wave one OpenSpec change`
