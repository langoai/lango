# Multi-Agent Coworking Wave 5 Implementation Plan
...
**Goal:** Land the first practical slice of Wave 5 by making mission-linked local coworking visible in Mission Control. The user should be able to see collaborating agents, recent handoffs, local blocked-on-teammate / blocked-on-approval states, and mission-linked budget/recovery signals without pretending full external team UX already exists.

**Architecture:** Wave 5 remains projection-first. It adds a collaboration projection over mission-linked local runtime signals:
...
- Create: `openspec/changes/multi-agent-coworking-wave-five/proposal.md`
- Create: `openspec/changes/multi-agent-coworking-wave-five/design.md`
- Create: `openspec/changes/multi-agent-coworking-wave-five/tasks.md`
- Create: `openspec/changes/multi-agent-coworking-wave-five/specs/mission-control-tui/spec.md`
- Modify: `README.md`
...
### Task 1: Create the Wave 5 OpenSpec Change
...
```bash
openspec validate multi-agent-coworking-wave-five --strict
```

Expected:

```text
Change 'multi-agent-coworking-wave-five' is valid
```
...
- not from Wave 4 loop/follow-up state in this first slice
...
- [ ] **Step 1: Audit landed Wave 5 behavior before editing docs**
...
- [ ] **Step 3: Run final Wave 5 review**

Before claiming Wave 5 complete:
