# Surface Split Slice 6 Implementation Plan
...
**Goal:** Land the first practical slice of Slice 6 by separating the interactive surfaces so bare `lango` launches a standalone mission workbench, `lango chat` stays focused chat, and `lango cockpit` stays the explicit multi-page operator dashboard.

**Architecture:** Slice 6 is a surface-contract change, not a new mission-domain slice. It adds a new `internal/cli/workbench` root shell that reuses the existing Mission Control projection/page stack, shared approval path, proposal path, loop path, and collaboration path without duplicating business logic. The full cockpit shell remains intact and explicit, while root CLI routing and public truth are updated so bare `lango` no longer aliases `lango cockpit`.
...
- Create: `openspec/changes/surface-split-slice-six/proposal.md`
- Create: `openspec/changes/surface-split-slice-six/design.md`
- Create: `openspec/changes/surface-split-slice-six/tasks.md`
- Create: `openspec/changes/surface-split-slice-six/specs/mission-workbench-tui/spec.md`
- Create: `openspec/changes/surface-split-slice-six/specs/mission-control-tui/spec.md`
- Create: `openspec/changes/surface-split-slice-six/specs/tui-cockpit-layout/spec.md`
- Create: `openspec/changes/surface-split-slice-six/specs/cockpit-shell/spec.md`
- Create: `openspec/changes/surface-split-slice-six/specs/cockpit-pages/spec.md`
- Create: `openspec/changes/surface-split-slice-six/specs/interactive-tui-chat/spec.md`
- Modify: `README.md`
...
### Task 1: Create the Slice 6 OpenSpec Change
...
```bash
openspec validate surface-split-slice-six --strict
```

Expected:

```text
Change 'surface-split-slice-six' is valid
```
...
```bash
openspec archive surface-split-slice-six --yes
```
