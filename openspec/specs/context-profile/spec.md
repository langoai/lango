...
Define the context profile system that bundles context engineering subsystem settings (Knowledge, Observational Memory, Embedding/RAG, Graph, Librarian) into named presets, with explicit-key-aware override protection via LoadResult.
