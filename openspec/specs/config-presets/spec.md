...
Preset profile system enabling one-line creation of purpose-specific configuration profiles (minimal, researcher, collaborator, full) instead of starting from DefaultConfig() every time.
