...
Buyer-side automatic payment tool (`p2p_invoke_paid`) that combines price query, spending limit enforcement, EIP-3009 authorization signing, and paid tool invocation into a single agent tool for seamless P2P paid interactions.
