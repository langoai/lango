# shared-line-reader Specification

## Purpose
Define the shared lower-level raw line reader contract used by prompt, approval, and other input paths that need deterministic single-line reads without caller-specific normalization.
## Requirements
