...
## Purpose
Provides a CLI command for viewing the X402 payment protocol configuration, including enabled state, wallet address, payment endpoint, and accepted token types.
