...
Define the TUI settings form fields for structured multi-agent orchestration (circuit breaker, budget, recovery policies) and trace store retention, exposed within existing Multi-Agent and Observability settings categories.
