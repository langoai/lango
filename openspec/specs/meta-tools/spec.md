...
- **AND** each entry SHALL expose `latest_dead_lettered_at`, `latest_manual_replay_actor`, `latest_manual_replay_at`, `latest_status_subtype`, `manual_retry_count`, `total_retry_count`, `transaction_global_total_retry_count`, `transaction_global_any_match_families`, `transaction_global_dominant_family`, `latest_status_subtype_family`, `any_match_families`, and `dominant_family`
