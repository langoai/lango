# EventMonitor Reorg Protection

## Purpose

Confirmation depth buffer and chain reorganization detection for the on-chain escrow event monitor. Protects against L2 reorgs on Base network by delaying event processing and detecting block rollbacks.
