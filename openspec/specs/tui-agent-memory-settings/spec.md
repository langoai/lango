# TUI Agent Memory Settings

## Purpose
Provides a TUI settings form for configuring the agent memory system, including enabling/disabling, setting default scope, confidence threshold, and maximum entries.
