...
- **AND** the remaining work SHALL be described as richer dead-letter CLI filters beyond latest subtype / latest family, richer CLI recovery UX, and broader operator summaries
