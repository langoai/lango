...
### Requirement: Learning suggestions stop claiming inline approval persistence in chat
Wave 1 SHALL NOT require the chat transcript surface to present learning suggestions as inline approvals that persist learning directly. Mission Control becomes the required projection surface for those suggestions, and chat may remain informational if it renders them at all.
