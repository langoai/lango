...
### Requirement: Learning suggestions render as proposed missions only
Mission Control SHALL project buffered learning suggestions as `proposed` missions for inspection, acceptance, or dismissal. In Wave 1, this is a UI proposal only and SHALL NOT imply durable mission creation or automatic learning persistence by itself.
...
#### Scenario: Proposal acceptance does not create durable mission state
