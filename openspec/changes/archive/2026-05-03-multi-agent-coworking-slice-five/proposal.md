...
Slice 5 exists to make local coworking visible without pretending that collaboration has become a new durable domain model or that external P2P team UX is already solved.
...
Slice 5 is intentionally narrow:
