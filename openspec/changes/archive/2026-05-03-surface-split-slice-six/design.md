...
The first Slice 6 slice defines three distinct interactive contracts:
...
Slice 6 reuses the existing Mission Control assets instead of forking the mission domain:
...
- the `surface-split-slice-six` change validates cleanly
