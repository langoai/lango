...
Slice 6 exists to make the interactive surfaces explicit and honest.
...
Slice 6 Task 1 is spec-only and intentionally narrow:
...
After the full slice lands, users should be able to infer the right entry point from the command name alone:
