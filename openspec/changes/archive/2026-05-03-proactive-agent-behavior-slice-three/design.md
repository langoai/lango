...
At the same time, Slice 3 must avoid overreaching. It should not silently launch generic proposal-owned executions, should not enable vague heuristic producers, and should not blur the boundary between transient proactive work and durable accepted mission truth.
...
Slice 3 introduces a transient proposal registry distinct from durable mission storage.
