...
- [x] Implement the Mission Control projector and page using deterministic Wave 1 rules only
- [x] Verify loading, empty, degraded, narrow-terminal, and approval-routing behavior with focused tests
- [x] Run `openspec validate 2026-05-02-mission-control-wave-one --strict`
