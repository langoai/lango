...
Use the Cobra command writer as the only output sink for learning inspection commands.
...
- none beyond updating tests to assert the command writer path explicitly
