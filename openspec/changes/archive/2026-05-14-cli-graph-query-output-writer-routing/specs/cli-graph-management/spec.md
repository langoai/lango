...
### Requirement: Graph query command output routing
`lango graph query` SHALL route human-readable and JSON output through the Cobra command writer instead of writing directly to process stdout.
