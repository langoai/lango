...
- [x] 1.1 Define `LoopView`, `AgendaView`, loop-kind, and loop-status types for the first Slice 4 slice
...
- [x] 4.1 Audit landed Slice 4 behavior before updating public docs
- [x] 4.2 Update README and cockpit docs to describe the real first-slice loop sources and explicit non-goals
- [x] 4.3 Run docs build, OpenSpec validation/verification, and final Slice 4 review before archive
