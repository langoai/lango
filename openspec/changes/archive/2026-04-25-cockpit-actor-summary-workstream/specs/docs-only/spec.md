...
#### Scenario: Dead-letter browsing page describes actor-rich cockpit summaries
...
- **AND** they SHALL find richer cockpit summary surfaces beyond top latest dead-letter reasons and top latest manual replay actors described as remaining work
