...
16. `dead-letter browsing / status observation` slice now includes local and transaction-global family grouping plus compact per-submission breakdown; the follow-on work is raw background-task bridges and higher-level cockpit or CLI surfaces
