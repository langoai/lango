...
The exportability policy work has already started as a first slice: source-based evaluation and operator visibility are now landed. The remaining work is richer policy rules, explicit override/dispute handling, and receipt unification.
