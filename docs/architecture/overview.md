...
graph TB
    ...
    subgraph AgentLayer["Agent Layer"]
        ADK["ADK Agent<br/>(Google ADK v0.6.0)"]
...
| Component | Package | Role |
|-----------|---------|------|
| **ADK Agent** | `internal/adk/` | Wraps Google ADK v0.6.0 (`llmagent.New`, `runner.Runner`). Provides `Run`, `RunAndCollect`, and `RunStreaming` methods |
