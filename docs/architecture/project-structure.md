...
| `cli/cockpit/` | `lango` / `lango cockpit` multi-panel TUI surface. Owns Mission Control, shared pending approval ownership, activity and learning buffers, durable-first mission projection, and the sidebar/detail-page shell around the shared chat model |
