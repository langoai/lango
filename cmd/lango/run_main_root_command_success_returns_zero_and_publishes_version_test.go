...
func TestRunMain_RootCommandSuccessReturnsZeroAndPublishesVersion(t *testing.T) {
	...
	Version = "runMainRootCommandSuccessReturnsZeroAndPublishesVersion-test"
	...
	assert.Equal(t, "runMainRootCommandSuccessReturnsZeroAndPublishesVersion-test", cliboot.Version)
}
