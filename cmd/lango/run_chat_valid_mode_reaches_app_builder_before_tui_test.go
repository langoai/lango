...
func TestRunChatValidModeReachesAppBuilderBeforeTUI(t *testing.T) {
	...
	boot := &bootstrap.Result{Config: cfg, ProfileName: "runChatValidModeReachesAppBuilderBeforeTui2"}
...
func TestRunCockpitDefaultUsesLocalChatModeBeforeTUI(t *testing.T) {
	restorePrepareTuiStartupInitializesLoggingAndRedirectsStdlibLogTUIProfile(t)
...
func TestRunWorkbenchPropagatesBootstrapAndLoggingErrors(t *testing.T) {
	restorePrepareTuiStartupInitializesLoggingAndRedirectsStdlibLogTUIProfile(t)
	...
	cfg.DataRoot = t.TempDir()
	workbenchBootLoaderFn = func() (*bootstrap.Result, error) {
		return &bootstrap.Result{Config: cfg, ProfileName: "runChatValidModeReachesAppBuilderBeforeTui2"}, nil
	}
...
func TestRunWorkbenchValidModeReachesAppBuilderBeforeTUI(t *testing.T) {
	restorePrepareTuiStartupInitializesLoggingAndRedirectsStdlibLogTUIProfile(t)
	origBootLoader := workbenchBootLoaderFn
	origLoggingInit := workbenchLoggingInitFn
	origLoggingSync := workbenchLoggingSyncFn
...
func TestCockpitCommandWithChannelsFlagRoutesModeAndSetsGlobal(t *testing.T) {
...
func TestRegisterCockpitPagesStatusPageUsesFeatureStatuses(t *testing.T) {
	t.Parallel()
	...
	registerCockpitPages(
		...
		"runChatValidModeReachesAppBuilderBeforeTui2",
		nil,
		cockpit.Deps{},
		chatModel,
	)
	...
	assert.Contains(t, view, "Cockpit Status")
	assert.Contains(t, view, "not configured")
}

func TestConfigCommandValueSubcommandsAreQuietOnErrors(t *testing.T) {
	cmd := configCmd()
