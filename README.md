...
Running `lango` without arguments starts an interactive terminal chat — a Claude Code-like experience with streaming responses, inline tool approval, and slash commands.
