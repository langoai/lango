...
| `logging.outputPath`                                   | string   |                             | Optional log file path; empty uses stderr                                                                         |
| **Session**                                            |          |                             |                                                                                                                   |
...
| `p2p.enableRelay`                                      | bool     | `true`                      | Enable relay for NAT traversal                                                                                    |
...
| `p2p.zkAttestation`                                    | bool     | `true`                      | Enable ZK response attestation                                                                                    |
| `p2p.sessionTokenTtl`                                  | duration | `24h0m0s`                   | Session token lifetime after handshake                                                                            |
...
| `p2p.toolIsolation.maxMemoryMB`                        | int      | `256`                       | Soft memory limit per tool process                                                                                |
